...
define(['N', './Class.ReportRenderer', '../Lib.Basic', '../Lib.Operations'],
    ...
    function (N, ReportRenderer, Basic, Operations) {
        ...
        var classes = Basic.Classes.GASTOS_ADM_OF;

        function createAccountNumberFilter() {
            let filter = ['AND'];
            filter.push([
                'account.number', 'startswith', Basic.Account.True.GASTOS_ADM_OF
            ]);

            Basic.Account.False.GASTOS_ADM_OF.forEach(number => {
                filter.push('AND');
        ...
        class GastosAdministrativosOficina extends ReportRenderer {
        ...
        return GastosAdministrativosOficina
