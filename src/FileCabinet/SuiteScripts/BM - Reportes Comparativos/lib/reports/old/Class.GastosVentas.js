...
define(['N', './Class.ReportRenderer', '../Lib.Basic', '../Lib.Operations'],
    ...
    function (N, ReportRenderer, Basic, Operations) {
        ...
        var classes = Basic.Classes.GASTOS_VENTAS;

        function createAccountNumberFilter() {
            let filter = ['AND'];
            filter.push(['account.number', 'startswith',  Basic.Account.True.GASTOS_VENTAS]);

            Basic.Account.False.GASTOS_VENTAS.forEach(number => {
                filter.push('AND');
        ...
        class GastosVentas extends ReportRenderer {
